...
#ifndef TVMET_MAP_VECTOR_OPERATORS_H
#define TVMET_MAP_VECTOR_OPERATORS_H
...
XprVector<								\
  ...
  >									\
>									\
operator OP (const Map<Vector<T1>>& lhs, 				\
	     const Map<Vector<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;	\
template<class T1, class T2>				\
XprVector<								\
  XprBinOp<								\
...
XprVector<								\
  ...
  >									\
>									\
operator OP (const Map<Vector<T>> & lhs, 					\
	     const XprVector<E>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
//  >									\
//>									\
//operator OP (const Map<Vector<T>>& lhs, TP rhs) TVMET_CXX_ALWAYS_INLINE;	\
//									\
//template<class T>					\
//XprVector<								\
//  XprBinOp<								\
...
//  >									\
//>									\
//operator OP (TP lhs, const Map<Vector<T>>& rhs) TVMET_CXX_ALWAYS_INLINE;
//
//// integer operators only, e.g used on double you wil get an error
//namespace element_wise {
...
XprVector<								\
  ...
  >									\
>									\
operator OP (const Map<Vector<T1>>& lhs, const Map<Vector<T2>>& rhs) {	\
  return NAME (lhs, rhs);						\
}									\
template<class T1, class T2>				\
inline									\
XprVector<								\
  ...
  >									\
>									\
operator OP (const Map<Vector<T1>> & lhs, const Vector<T2>& rhs) {	\
  return NAME (lhs, rhs);						\
}									\
template<class T1, class T2>				\
inline									\
XprVector<								\
  ...
  >									\
>									\
operator OP (const Vector<T1>& lhs, const Map<Vector<T2>>& rhs) {	\
  return NAME (lhs, rhs);						\
}									\
									\
template<class E, class T>				\
...
XprVector<								\
  ...
  >									\
>									\
operator OP (const XprVector<E>& lhs, const Map<Vector<T>>& rhs) {	\
  return NAME (lhs, rhs);						\
}									\
									\
template<class E, class T>				\
...
XprVector<								\
  ...
  >									\
>									\
operator OP (const Map<Vector<T>>& lhs, const XprVector<E>& rhs) {	\
  return NAME (lhs, rhs);						\
}
...
XprVector<						\
  ...
  >							\
>							\
operator OP (const Map<Vector<T>>& lhs, POD rhs) {	\
  return NAME (lhs, rhs);				\
}							\
							\
template<class T>			\
...
XprVector<						\
  ...
  >							\
>							\
operator OP (POD lhs, const Map<Vector<T>>& rhs) {	\
  return NAME (lhs, rhs);				\
}
