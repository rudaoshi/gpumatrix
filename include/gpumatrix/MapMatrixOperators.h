...
#ifndef TVMET_MAP_MATRIX_OPERATORS_H
#define TVMET_MAP_MATRIX_OPERATORS_H
...
XprMatrix<									\
  ...
  >									\
>										\
operator OP (const Map<Matrix<T1>>& lhs,					\
	     const Map<Matrix<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;	\
template<class T1, class T2>		\
XprMatrix<									\
  XprBinOp<									\
...
XprMatrix<									\
  ...
  >									\
>										\
operator OP (const Map<Matrix<T>>& lhs, 					\
	     const XprMatrix<E>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
XprMatrix<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs,
	  const Map<Matrix<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
//  >									\
//>										\
//operator OP (const Map<Matrix<T>>& lhs, TP rhs) TVMET_CXX_ALWAYS_INLINE;	\
//										\
//template<class T>				\
//XprMatrix<									\
//  XprBinOp<									\
...
//  >									\
//>										\
//operator OP (TP lhs, const Map<Matrix<T>>& rhs) TVMET_CXX_ALWAYS_INLINE;
//
//// integer operators only, e.g used on double you wil get an error
//namespace element_wise {
...
template<class T>
inline
std::ostream& operator<<(std::ostream& os, const Map<Matrix<T>>& rhs) {
...
inline 										\
Map<Matrix<T1>>&								\
operator OP (Map<Matrix<T1>>& lhs, const Map<Matrix<T2>>& rhs) {	\
  return lhs.M_##NAME(rhs);							\
}										\
template<class T1, class T2>		\
inline 										\
Map<Matrix<T1>>&								\
operator OP (Map<Matrix<T1>>& lhs, const Matrix<T2>& rhs) {	\
  return lhs.M_##NAME(rhs);							\
}										\
template<class T1, class T2>		\
inline 										\
Matrix<T1>&								\
operator OP (Matrix<T1>& lhs, const Map<Matrix<T2>>& rhs) {	\
  return lhs.M_##NAME(rhs);							\
}										\
										\
template<class T, class E,  std::size_t Cols>			\
inline 										\
Map<Matrix<T>>&								\
operator OP (Map<Matrix<T>>& lhs, const XprMatrix<E>& rhs) {	\
  return lhs.M_##NAME(rhs);							\
}
...
XprMatrix<									      \
  ...
  >								      \
>										      \
operator OP (const Map<Matrix<T1>> & lhs,	const Map<Matrix<T2>> & rhs) {  \
  return NAME(lhs, rhs);							      \
}										      \
template<class T1, class T2>		      \
inline										      \
XprMatrix<									      \
  ...
  >								      \
>										      \
operator OP (const Map<Matrix<T1>> & lhs,	const Matrix<T2>& rhs) {  \
  return NAME(lhs, rhs);							      \
}										      \
template<class T1, class T2>		      \
inline										      \
XprMatrix<									      \
  ...
  >								      \
>										      \
operator OP (const Matrix<T1>& lhs,	const Map<Matrix<T2>> & rhs) {  \
  return NAME(lhs, rhs);							      \
}										      \
										      \
template<class E, class T>			      \
...
XprMatrix<									      \
  ...
  >								      \
>										      \
operator OP (const XprMatrix<E>& lhs, const Map<Matrix<T>> & rhs) { \
  return NAME(lhs, rhs);							      \
}										      \
										      \
template<class T, class E>			      \
...
XprMatrix<									      \
  ...
  >								      \
>										      \
operator OP (const Map<Matrix<T>>& lhs, const XprMatrix<E>& rhs) { \
  return NAME(lhs, rhs);							      \
}
...
XprMatrix<							\
  ...
  >							\
>								\
operator OP (const Map<Matrix<T>>& lhs, POD rhs) {	\
  return NAME (lhs, rhs);					\
}								\
								\
template<class T>		\
...
XprMatrix<							\
  ...
  >							\
>								\
operator OP (POD lhs, const Map<Matrix<T>>& rhs) {	\
  return NAME (lhs, rhs);					\
}
...
XprMatrix<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs, const Map<Matrix<T2>>& rhs) {
  return prod(lhs, rhs);
}
...
XprMatrix<
  ...
  >
>
operator*(const Matrix<T1>& lhs, const Map<Matrix<T2>>& rhs) {
  return prod(lhs, rhs);
}
...
XprMatrix<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs, const Matrix<T2>& rhs) {
  return prod(lhs, rhs);
}
...
XprMatrix<
  ...
  >
>
operator*(const XprMatrix<E1>& lhs, const Map<Matrix<T2>>& rhs) {
  return prod(lhs, rhs);
}
...
XprMatrix<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs, const XprMatrix<E2>& rhs) {
  return prod(lhs, rhs);
}
...
XprVector<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs, const Vector<T2>& rhs) {
  return prod(lhs, rhs);
}
...
XprVector<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs, const Map<Vector<T2>>& rhs) {
  return prod(lhs, rhs);
}
...
XprVector<
  ...
  >
>
operator*(const Map<Matrix<T1>>& lhs, const XprVector<E2>& rhs) {
  return prod(lhs, rhs);
}
...
//    XprMatrix<MatrixConstReference<T2>>						\
//  >							expr_type;			\
//  return XprMatrix<expr_type>(expr_type(lhs.as_expr(), rhs.as_expr()));	\
//}											\
//											\
//template<class E,									\
//	 class T>					\
...
//    XprMatrix<MatrixConstReference<T>>							\
//  > 							 expr_type;			\
//  return XprMatrix<expr_type>(expr_type(lhs, rhs.as_expr()));		\
//}											\
//											\
//template<class T,					\
//	 class E>									\
...
//    XprMatrix<E>								\
//  >	 						 expr_type;			\
//  return XprMatrix<expr_type>(expr_type(lhs.as_expr(), rhs));		\
//}
//
//// integer operators only, e.g used on double you wil get an error
//namespace element_wise {
