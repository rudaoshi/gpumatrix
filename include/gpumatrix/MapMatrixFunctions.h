...
#ifndef TVMET_MAP_MATRIX_FUNCTIONS_H
#define TVMET_MAP_MATRIX_FUNCTIONS_H
...
/*
 * function( Map<Matrix<T1>>, Map<Matrix<T2>>)
 * function(Matrix<T1>, Map<Matrix<T2>>)
 * function(Map<Matrix<T1>>, Matrix<T2>)
 */
...
XprMatrix<								\
  ...
  >								\
>									\
NAME (const Map<Matrix<T>>& lhs,				\
      const Map<Matrix<T>>& rhs) TVMET_CXX_ALWAYS_INLINE;	\
									\
template<class T>	\
XprMatrix<								\
  XprBinOp<								\
...
/*
 * function(Map<Matrix<T1>>, Map<Matrix<T2>>)
 * function(XprMatrix<E>, Map<Matrix<T>>)
 * function(Map<Matrix<T>>, XprMatrix<E>)
 */
#define TVMET_DECLARE_MACRO(NAME)					\
...
XprMatrix<
  ...
  >/*	*/						// return Dim
>
prod(const Map<Matrix<T1>>& lhs,
     const Map<Matrix<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
XprMatrix<
  ...
  >							// return Dim
>
MtMt_prod(const Map<Matrix<T1>>& lhs,
	   const Map<Matrix<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
XprMatrix<
  ...
  >							// return Dim
>
MtM_prod(const Map<Matrix<T1>>& lhs,
	 const Map<Matrix<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
XprMatrix<
  ...
  >							// return Dim
>
MMt_prod(const Map<Matrix<T1>>& lhs,
	 const Map<Matrix<T2>>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
#pragma region Matrix-Vector Prod
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
XprVector<
  ...
  >
>
MtV_prod(const Map<Matrix<T1>>& lhs,
	 const Vector<T2>& rhs) TVMET_CXX_ALWAYS_INLINE;
...
XprMatrix<									\
  ...
  >									\
>										\
NAME (const Map<Matrix<T>>& lhs, const Map<Matrix<T>>& rhs) {	\
  typedef XprBinOp <								\
    Fcnl_##NAME<T, T>,							\
    XprMatrix<MatrixConstReference<T>>,					\
    XprMatrix<MatrixConstReference<T>>					\
...
XprMatrix<									\
  ...
  >									\
>										\
NAME (const Matrix<T>& lhs, const Map<Matrix<T>>& rhs) {	\
  typedef XprBinOp <								\
    Fcnl_##NAME<T, T>,							\
    XprMatrix<MatrixConstReference<T>>,					\
    XprMatrix<MatrixConstReference<T>>					\
...
XprMatrix<									\
  ...
  >									\
>										\
NAME (const Map<Matrix<T>>& lhs, const Matrix<T>& rhs) {	\
  typedef XprBinOp <								\
    Fcnl_##NAME<T, T>,							\
    XprMatrix<MatrixConstReference<T>>,					\
    XprMatrix<MatrixConstReference<T>>					\
...
XprMatrix<									\
  ...
  >									\
>										\
NAME (const XprMatrix<E>& lhs, const Map<Matrix<T>>& rhs) {	\
  typedef XprBinOp<								\
    Fcnl_##NAME<typename E::value_type, T>,					\
    XprMatrix<E>,							\
    XprMatrix<MatrixConstReference<T>>						\
...
XprMatrix<									\
  ...
  >									\
>										\
NAME (const Map<Matrix<T>>& lhs, const XprMatrix<E>& rhs) {	\
  typedef XprBinOp<								\
...
XprMatrix<								\
  ...
  >								\
>									\
NAME (const Map<Matrix<T>>& lhs, POD rhs) {			\
  typedef XprBinOp<							\
    Fcnl_##NAME<T, POD >,						\
    XprMatrix<MatrixConstReference<T>>,				\
    XprLiteral< POD >							\
...
XprMatrix<								\
  ...
  >								\
>									\
NAME (POD lhs, const Map<Matrix<T>>& rhs) {			\
  typedef XprBinOp<							\
    Fcnl_##NAME< POD, T>,						\
    XprLiteral< POD >,							\
    XprMatrix<MatrixConstReference<T>>					\
...
XprMatrix<
  ...
  >							// return Dim
>
prod(const Map<Matrix<T1>>& lhs, const Map<Matrix<T2>>& rhs) {
...
XprMatrix<
  ...
  >							// return Dim
>
prod(const Matrix<T1>& lhs, const Map<Matrix<T2>>& rhs) {
  typedef XprMMProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
prod(const Map<Matrix<T1>>& lhs, const Matrix<T2>& rhs) {
  typedef XprMMProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
prod(const XprMatrix<E1>& lhs, const Map<Matrix<T2>>& rhs) {
  typedef XprMMProduct<
    XprMatrix<E1>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
prod(const Map<Matrix<T1>>& lhs, const XprMatrix<E2>& rhs) {
  typedef XprMMProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<E2>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
MtMt_prod(const Map<Matrix<T1>>& lhs, const Map<Matrix<T2>>& rhs) {
...
XprMatrix<
  ...
  >							// return Dim
>
MtMt_prod(const Matrix<T1>& lhs, const Map<Matrix<T2>>& rhs) {
  typedef XprMtMtProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
MtMt_prod(const Map<Matrix<T1>>& lhs, const Matrix<T2>& rhs) {
  typedef XprMtMtProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
MtM_prod(const Map<Matrix<T1>>& lhs, const Map<Matrix<T2>>& rhs) {
...
XprMatrix<
  ...
  >							// return Dim
>
MtM_prod(const Matrix<T1>& lhs, const Map<Matrix<T2>>& rhs) {
  typedef XprMtMProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
MtM_prod(const Map<Matrix<T1>>& lhs, const Matrix<T2>& rhs) {
  typedef XprMtMProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
MMt_prod(const Map<Matrix<T1>>& lhs, const Map<Matrix<T2>>& rhs) {
...
XprMatrix<
  ...
  >							// return Dim
>
MMt_prod(const Matrix<T1>& lhs, const Map<Matrix<T2>>& rhs) {
  typedef XprMMtProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprMatrix<
  ...
  >							// return Dim
>
MMt_prod(const Map<Matrix<T1>>& lhs, const Matrix<T2>& rhs) {
  typedef XprMMtProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprMatrix<MatrixConstReference<T2>>
  >							expr_type;
...
XprVector<
  ...
  >
>
prod(const Map<Matrix<T1>>& lhs, const Vector<T2>& rhs) {
...
XprVector<
  ...
  >
>
prod(const Map<Matrix<T1>>& lhs, const XprVector<E2>& rhs) {
  typedef XprMVProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprVector<E2>
  > 							expr_type;
...
XprVector<
  ...
  >
>
MtV_prod(const Map<Matrix<T1>>& lhs, const Vector<T2>& rhs) {
...
XprVector<
  ...
  >
>
MtV_prod(const Map<Matrix<T1>>& lhs, const Map<Vector<T2>>& rhs) {
  typedef XprMtVProduct<
    XprMatrix<MatrixConstReference<T1>>,
    XprVector<VectorConstReference<T2>>
  > 							expr_type;
