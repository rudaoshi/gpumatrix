...
#ifndef TVMET_MAP_ARRAY_FUNCTIONS_H
#define TVMET_MAP_ARRAY_FUNCTIONS_H
...
/*
 * function(Map<Matrix<T1>>, Map<Matrix<T2>>)
 * function(XprArray<E,D>, Map<Array<T,D>>)
 * function(Map<Array<T,D>>, XprArray<E,D>)
 */
#define TVMET_DECLARE_MACRO(NAME)					\
...
XprArray<									\
  ...
  >	, D									\
>										\
NAME (const Map<Array<T,D>>& lhs, const Map<Array<T,D>>& rhs) {	\
  typedef XprBinOp <								\
    Fcnl_##NAME<T, T>,							\
    XprArray<ArrayConstReference<T,D>,D>,					\
    XprArray<ArrayConstReference<T,D>,D>					\
...
XprArray<									\
  ...
  >	,D								\
>										\
NAME (const Array<T,D>& lhs, const Map<Array<T,D>>& rhs) {	\
  typedef XprBinOp <								\
    Fcnl_##NAME<T, T>,							\
    XprArray<ArrayConstReference<T,D>,D>,					\
    XprArray<ArrayConstReference<T,D>,D>					\
...
XprArray<									\
  ...
  >	, D									\
>										\
NAME (const Map<Array<T,D>>& lhs, const Array<T,D>& rhs) {	\
  typedef XprBinOp <								\
    Fcnl_##NAME<T, T>,							\
    XprArray<ArrayConstReference<T,D>,D>,					\
    XprArray<ArrayConstReference<T,D>,D>					\
...
XprArray<									\
  ...
  >	, D									\
>										\
NAME (const XprArray<E,D>& lhs, const Map<Array<T,D>>& rhs) {	\
  typedef XprBinOp<								\
    Fcnl_##NAME<typename E::value_type, T>,					\
    XprArray<E,D>,							\
    XprArray<ArrayConstReference<T,D>,D>						\
...
XprArray<									\
  ...
  >		, D								\
>										\
NAME (const Map<Array<T,D>>& lhs, const XprArray<E,D>& rhs) {	\
  typedef XprBinOp<								\
...
XprArray<								\
  ...
  >		, D							\
>									\
NAME (const Map<Array<T,D>>& lhs, POD rhs) {			\
  typedef XprBinOp<							\
    Fcnl_##NAME<T, POD >,						\
    XprArray<ArrayConstReference<T,D>,D>,				\
    XprLiteral< POD >							\
...
XprArray<								\
  ...
  >	, D								\
>									\
NAME (POD lhs, const Map<Array<T,D>>& rhs) {			\
  typedef XprBinOp<							\
    Fcnl_##NAME< POD, T>,						\
    XprLiteral< POD >,							\
    XprArray<ArrayConstReference<T,D>,D>					\
